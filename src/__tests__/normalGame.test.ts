  ...
  describe("generateStats()", () => {
    ...
    const testCases: TestCase[] = [
      ...
      },
      {
        ...
        points: [6, 5],
        expected: { status: "in-progress", winnerIndex: null, points: [6, 5] },
      },
